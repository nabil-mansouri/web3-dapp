...
interface TokenManagerAbstractInterface extends ethers.utils.Interface {
  functions: {
...
export class TokenManagerAbstract extends Contract {
  ...
  interface: TokenManagerAbstractInterface;
